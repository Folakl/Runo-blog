...
const Richard = () => {
  ...
  return (
    <div className='bg-[grey] py-[200px]'>
        <div className='grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 lg:gap-0 md:gap-10 gap-10 my-10 lg:mx-5 md:mx-5 ' >
       {blog.map((image) => (
        <div key={image.id}>
             <div className='lg:w-[500px] md:w-[500px] w-[350px] lg:h-[500px] md:h-[500px] h-[450px]  text-white justify-center lg:mx-10 md:mx-10 mx-5 ' style={
                {
