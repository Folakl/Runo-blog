...
const Editorspickstwo = () => {
  ...
  return (
    <div className='grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 lg:gap-2 md:gap-10 gap-8 my-10 lg:mx-5 md:mx-5 ' >
       {image.map((one) => (
        <div key={one.id}>
             <div className='lg:w-[600px] md:w-[350px] w-[350px] lg:h-[600px] md:h-[500px] h-[500px]  text-white     lg:mx-10 md:mx-10 mx-5' style={
                {
                 ...
                 <button className='w-[100px] h-[30px] ml-[150px] mt-5 rounded-md bg-transparent border-2 border-black'>ADVENTURE</button>
